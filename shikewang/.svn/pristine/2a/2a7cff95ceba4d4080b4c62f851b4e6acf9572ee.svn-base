...
public class TopAndBottomLoadListView extends ListView implements OnScrollListener {
	...
	public TopAndBottomLoadListView(Context context) {
		super(context);
		initView(context);
	}

	public TopAndBottomLoadListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public TopAndBottomLoadListView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void onRefreshComplete() {
		String currentTime = Timer_Uils.getCurrentTime();
	...
	private void whenMove(MotionEvent ev) {
		...
		int topPadding = (space - headerContentHeight)/2;
		switch (state) {
		case NONE:
			if (space > 0) {
				state = PULL;
